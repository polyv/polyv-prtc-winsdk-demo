...
typedef enum {
	...
	PRTC_CALLBACK_ERR_INVAILDSTATE, // 服务端连接断开
	PRTC_CALLBACK_ERR_INVAILDPARAMETER, // 无效参数
	...
	PRTC_CALLBACK_ERR_MSG_RECORDSTART, //录制已开启
	PRTC_CALLBACK_ERR_MSG_RELAYSTART,  //转推已开启
	PRTC_CALLBACK_ERR_MSG_RELAYURLNOTEXISTED, //转推地址不存在
	PRTC_CALLBACK_ERR_MSG_URLERROR,  //CDN地址无效
	PRTC_CALLBACK_ERR_MSG_NOSTREAMS, //房间内无流
	PRTC_CALLBACK_ERR_MSG_VIDEODVICEERR, //视频设备出错
	PRTC_CALLBACK_ERR_MSG_RECORDDVICEERR, //mic 录音设备出错
...
typedef enum {
    ...
    PRTC_RETURN_ERR_INVAILED_STATE,   //内部状态错误
    PRTC_RETURN_ERR_INVAILED_POINTER,   //指针错误
    PRTC_RETURN_ERR_DROPPED,  //丢帧
} ePRTCReturnErrCode;
