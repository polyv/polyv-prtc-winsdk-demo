...
public:
    ...
    virtual void OnMuteAudio(std::string userid, ePRTCMeidaType mediatype,  bool mute) = 0;
	virtual void OnMuteVideo(std::string userid, ePRTCMeidaType mediatype, bool mute) = 0;
...
public:
	...
	void SetType(ePRTCMeidaType type);
	void TestEnble();
